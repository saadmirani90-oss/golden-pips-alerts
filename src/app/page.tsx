          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-700/50 border border-yellow-400/20 hover:border-yellow-400/50 rounded-lg p-6 transition-all duration-300">
              ...
              <p className="text-slate-300">
                Get instant notifications of trading opportunities as they occur in the market
              </p>
            </div>
            ...
            <div className="bg-slate-700/50 border border-yellow-400/20 hover:border-yellow-400/50 rounded-lg p-6 transition-all duration-300">
              ...
              <p className="text-slate-300">
                Detailed market analysis from professional traders with years of experience
              </p>
            </div>
            ...
            <div className="bg-slate-700/50 border border-yellow-400/20 hover:border-yellow-400/50 rounded-lg p-6 transition-all duration-300">
              ...
              <p className="text-slate-300">
                98% win rate with precise entry and exit points for maximum profitability
              </p>
            </div>
            ...
            <div className="bg-slate-700/50 border border-yellow-400/20 hover:border-yellow-400/50 rounded-lg p-6 transition-all duration-300">
              ...
              <p className="text-slate-300">
                Premium channel with verified signals and consistent performance tracking
              </p>
            </div>
